...
/**
 * Data class to get the required data for a theme
 */
class Theme {
	 ...
	 * @param string $default_value Default return value if key doesn't exist.
	 *
	 * @return mixed|string
	 */
	public function get_wp_org_data( $key = '', $default_value = '' ) {
		...
		return isset( $this->wp_org[ $key ] ) ? $this->wp_org[ $key ] : $default_value;
	}
	 ...
	 * @param mixed  $default_value Default return value if key doesn't exist.
	 *
	 * @return mixed
	 */
	public function get_theme_update_data( $key, $default_value = null ) {
